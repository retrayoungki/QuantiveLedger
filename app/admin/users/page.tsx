...
import { collection, getDocs, doc, setDoc, deleteDoc } from "firebase/firestore"; // We will use firestore, auth is client side
...
export default function UserManagementPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="glass-panel rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-200/50 overflow-hidden">
